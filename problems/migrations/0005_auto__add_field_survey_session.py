...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.session'
        db.add_column(u'problems_survey', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['problems.Session'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Survey.session'
        db.delete_column(u'problems_survey', 'session_id')
    ...
    models = {
        ...
        u'problems.survey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person_type': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['problems.PersonType']", 'symmetrical': 'False'}),
