...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'problems_problem', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Problem.image'
        raise RuntimeError("Cannot reverse this migration. 'Problem.image' and its values cannot be restored.")
