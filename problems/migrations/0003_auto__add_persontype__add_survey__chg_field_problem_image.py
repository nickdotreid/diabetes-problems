...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'problems_survey', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['problems.PersonType'], null=True)),
            ('birth_year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'problems', ['Survey'])


        # Changing field 'Problem.image'
        db.alter_column(u'problems_problem', 'image', self.gf('athumb.fields.ImageWithThumbsField')(max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Problem.image'
        db.alter_column(u'problems_problem', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        u'problems.survey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['problems.PersonType']", 'null': 'True'})
        }
    }
