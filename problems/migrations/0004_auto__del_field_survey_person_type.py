...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Survey.person_type'
        db.delete_column(u'problems_survey', 'person_type_id')
    ...
    def backwards(self, orm):
        # Adding field 'Survey.person_type'
        db.add_column(u'problems_survey', 'person_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['problems.PersonType'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'problems.survey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person_type': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['problems.PersonType']", 'null': 'True', 'symmetrical': 'False'})
        }
    }
